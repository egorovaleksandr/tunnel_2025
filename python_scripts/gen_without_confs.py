...
print('Generating tunnel configs without anomaly', end=' ')
...
with open('tunnel_confs/template_without.conf', 'r') as conf_3D: 
    t_3D = conf_3D.read()
    ...
    for z in source_z:
        ...
        open('tunnel_confs/without_' + str(z) + '.conf', 'w+').write(t)
